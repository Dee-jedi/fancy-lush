...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#faf9f6] selection:bg-[var(--secondary)] selection:text-white">
      <Header />
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-serif text-[var(--primary)] mb-8">A Sanctuary of Serenity</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative aspect-square rounded-full overflow-hidden border-[12px] border-[#faf9f6]"
            >
              <img 
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8 }}
            >
              <span className="text-[10px] tracking-[0.4em] uppercase font-bold text-[var(--secondary)] mb-4 block">
                Meet The Visionary
              </span>
              <h2 className="text-4xl md:text-6xl font-serif text-[var(--primary)] mb-8">The Face Behind The Glow</h2>
              <p className="text-lg text-[var(--foreground)]/60 font-light leading-relaxed mb-6">
              ...
              <p className="text-lg text-[var(--foreground)]/60 font-light leading-relaxed mb-10">
              ...
              <div className="pt-4 border-t border-[var(--primary)]/10 inline-block">
                <span className="font-serif italic text-3xl text-[var(--primary)]">Hadarah</span>
                <span className="block text-xs tracking-widest text-[var(--foreground)]/40 uppercase mt-2">Founder & CEO</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-40 px-6 text-center bg-[var(--primary)] text-white">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
            <a href="https://tiktok.com/@fancylush_spa" target="_blank" rel="noreferrer" className="group flex flex-col items-center">
              <div className="w-20 h-20 rounded-full border-2 border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-[var(--primary)] transition-all duration-500 mb-6">
