      ...
      >
        <Link href="/cart" className="group block relative">
          <motion.div
            ...
            whileTap={{ scale: 0.9 }}
            className="w-20 h-20 bg-[#222] text-white rounded-full shadow-[0_20px_50px_rgba(46,16,101,0.3)] flex items-center justify-center relative border border-white/20 backdrop-blur-xl"
          >
