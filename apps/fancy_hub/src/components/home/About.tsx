      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-3xl md:text-5xl font-serif text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-white via-[#d1d5db] to-[#9ca3af] italic font-light">Artistic Elegance.</span>
          </h2>
        ...
        <div className="relative aspect-square md:aspect-4/5 rounded-[2.5rem] overflow-hidden border border-white/10 group shadow-2xl">
          <Image
          ...
          />
          <div className="absolute inset-0 bg-linear-to-t from-[#060608]/80 via-[#060608]/10 to-transparent"></div>

          {/* Embedded Luxury Seal */}
          <div className="absolute bottom-6 left-6 right-6 sm:right-auto sm:left-6 sm:bottom-6 bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-3xl max-w-[240px] text-white">
            <span className="text-[7px] tracking-[0.3em] font-black text-white/60 uppercase block mb-1">CERTIFIED CARE</span>
            <p className="text-[10px] font-light text-white/80 leading-relaxed">
