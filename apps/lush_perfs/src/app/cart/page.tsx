...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    const itemsList = cart.map(item => {
      const displayRef = item.refCode ? ` (Ref: ${item.refCode})` : '';
      return `- ${item.name}${displayRef} (x${item.quantity}) - ${item.price}\n  View: ${baseUrl}/products/${item.id}`;
    }).join('\n\n');
        ...
        {cart.length === 0 ? (
          ...
          >
            ...
            <Link href="/" className="inline-block">
              <button className="px-10 py-3.5 bg-linear-to-r from-[#8e5e38] via-[#c89666] to-[#f5d6c6] hover:scale-105 transition-transform text-[#050404] text-[9px] tracking-widest font-black uppercase rounded-full shadow-lg">
                Explore Boutique
              </button>
            </Link>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
              ...
              <AnimatePresence mode='popLayout'>
                {cart.map((item) => (
                  <motion.div
                    ...
                    className="bg-[#110c0a]/40 rounded-4xl p-6 flex items-center gap-6 border border-[white]/5 relative group shadow-xl"
                  >
                    <div className="w-20 h-20 flex-none rounded-3xl overflow-hidden shadow-md relative border border-[white]/5">
                    ...
                    <div className="grow space-y-1">
                      ...
                      <div className="flex items-center justify-between pt-2">
                        <div className="flex items-center gap-3">
                          <p className="text-transparent bg-clip-text bg-linear-to-r from-[#8e5e38] via-[#c89666] to-[#f5d6c6] font-bold font-serif italic text-sm md:text-base">
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#110c0a]/50 rounded-4xl p-8 border border-[white]/5 shadow-2xl sticky top-28 space-y-6">
                ...
                <div className="pt-4 border-t border-[white]/5">
                  <div className="flex justify-between items-baseline mb-8">
                    ...
                    <span className="text-2xl font-serif font-black text-transparent bg-clip-text bg-linear-to-r from-[#8e5e38] via-[#c89666] to-[#f5d6c6]">
