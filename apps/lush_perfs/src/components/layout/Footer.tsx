...
export function Footer() {
  return (
    <footer className="bg-[#050404] border-t border-[white]/5 py-16 px-6 md:px-12 relative z-20 text-[white]/50 text-xs">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 items-start">
        
        {/* Brand Meta */}
        <div className="space-y-4">
          <Link href="/" className="flex items-baseline gap-2">
            <span className="font-serif text-xl tracking-[0.2em] font-extrabold uppercase text-transparent bg-clip-text bg-linear-to-r from-[#8e5e38] via-[#c89666] to-[#f5d6c6]">
              LUSH
            </span>
