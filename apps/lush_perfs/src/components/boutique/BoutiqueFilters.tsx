      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex justify-between items-center w-full">
          ...
          <div className="relative w-[300px] group">
            <div className="absolute inset-0 bg-[#c89666]/10 rounded-full blur-sm opacity-0 group-focus-within:opacity-30 transition-opacity duration-500"></div>
            <input
              type="text"
              value={searchQuery}
