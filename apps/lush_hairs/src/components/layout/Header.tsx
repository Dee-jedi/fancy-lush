          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:block">
              <Button 
                ...
                size="sm" 
                rounded="full"
                className="bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] border-0 text-white px-8 py-3 tracking-[0.3em] font-black"
              >
                BOOK STYLIST
              </Button>
            </div>
            ...
            >
              <div className="relative h-full flex flex-col pt-4">
                    ...
                    return (
                      <div key={item.name} className="flex flex-col items-start gap-1">
                        <motion.a
                          ...
                          onClick={() => setIsOpen(false)}
                          className={`text-4xl font-serif ${isActive ? 'text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)]' : 'text-white/70'} hover:text-[var(--primary)] transition-all duration-300 tracking-tight`}
                        >
                          {item.name}
                        </motion.a>
                        {isActive && (
                          <motion.div 
                            ...
                            className="w-12 h-1 bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] rounded-full mt-1"
                ...
                <div className="pb-12 mt-auto">
                  ...
                  >
                    <Button onClick={() => window.location.href='/book'} variant="primary" className="w-full py-6 text-xs tracking-[0.3em] rounded-2xl bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] border-0">
                      BOOK STYLIST
                    </Button>
                  </motion.div>
                  <div className="mt-12 pt-8 border-t border-white/10 text-center">
                    <p className="text-[10px] tracking-[0.2em] font-black uppercase text-white/30">Lush Hairs Boutique</p>
                  </div>
                </div>
              </div>
            </motion.div>
