    ...
    <main className="min-h-screen bg-[var(--background)] overflow-hidden">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#08080b] via-transparent to-[#08080b]/60 z-20"></div>
          <div className="absolute top-1/4 -left-1/4 w-[60%] h-[60%] bg-[var(--primary)]/15 rounded-full blur-[150px] mix-blend-screen pointer-events-none z-10"></div>
          <div className="absolute bottom-1/4 -right-1/4 w-[60%] h-[60%] bg-[var(--secondary)]/15 rounded-full blur-[150px] mix-blend-screen pointer-events-none z-10"></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center z-30 relative pt-24">
          <motion.div
            ...
            className="space-y-6"
          >
            <span className="text-[10px] tracking-[0.4em] font-black uppercase text-[var(--primary)] bg-white/5 border border-white/10 px-6 py-2 rounded-full backdrop-blur-md">
              Atelier of Bold Expression
            </span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white tracking-tight">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary)] via-pink-400 to-[var(--secondary)] italic font-light">Lush Hairs</span> Story
            </h1>
      ...
      <section className="py-32 px-6 relative z-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-6 relative">
            <div className="absolute -top-12 -left-12 w-48 h-48 bg-[var(--primary)]/10 rounded-full blur-3xl pointer-events-none"></div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-[var(--primary)]/10 to-transparent z-10 mix-blend-overlay"></div>
              <Image
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#08080b]/90 p-6 z-20">
                <span className="text-[8px] tracking-[0.2em] font-black uppercase text-[var(--primary)] block mb-1">Ethical Sourcing</span>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-[var(--secondary)]/10 to-transparent z-10 mix-blend-overlay"></div>
              <Image
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#08080b]/90 p-6 z-20">
                <span className="text-[8px] tracking-[0.2em] font-black uppercase text-[var(--secondary)] block mb-1">Expert Craft</span>
          ...
          <div className="space-y-8 lg:pl-6">
            <span className="text-[10px] tracking-[0.4em] font-black uppercase text-[var(--primary)]">Crafted Without Compromise</span>
      ...
      <section className="py-32 px-6 relative z-10 bg-white/[0.01] border-y border-white/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">

          {/* Bio Story */}
          <div className="space-y-8 order-2 lg:order-1">
            <span className="text-[10px] tracking-[0.4em] font-black uppercase text-[var(--primary)]">The Visionary</span>
            <h2 className="text-4xl md:text-5xl font-serif text-white leading-tight">
              Hadarah <br />
              <span className="italic text-white/40">Founder & CEO</span>
            </h2>
            <div className="relative p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl shadow-xl">
              <div className="absolute top-6 left-6 text-6xl text-[var(--primary)]/10 font-serif leading-none">“</div>
          ...
          <div className="order-1 lg:order-2 flex justify-center relative">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-[var(--primary)]/10 rounded-full blur-[100px] pointer-events-none z-0"></div>
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-[var(--primary)]/20 to-transparent z-10 mix-blend-overlay"></div>
              <Image
      ...
      <section className="py-32 px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <span className="text-[10px] tracking-[0.4em] font-black uppercase text-[var(--primary)]">Join the Atelier</span>
          ...
          <div className="flex flex-wrap justify-center gap-6 pt-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-[var(--primary)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
            ...
            <button
              ...
              className="group relative px-8 py-4 rounded-full overflow-hidden border border-white/10 hover:border-transparent bg-white/5 transition-all duration-500 hover:scale-105"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-black to-[var(--secondary)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
